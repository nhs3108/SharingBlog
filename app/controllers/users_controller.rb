class UsersController < ApplicationController
  ...
  # GET /users/1.json
  def show
    @feed_items = current_user.entries.paginate(page: params[:page], per_page: 5)
  end
  ...
  def update
    respond_to do |format|
      if @user.update(user_params_without_email)
  ...
  private
    ...
    def user_params_without_email
      params.require(:user).permit(:name, :picture, :password, :password_confirmation)
    end
end
